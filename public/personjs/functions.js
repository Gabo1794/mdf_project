$( document ).ready(function() {
  $('div[data-class="flex"]').css('display','flex');
});
...
function ObtenerDatos(){
  ...
  if( fecha_nac == null || fecha_nac == ''){ return; };
  if( fecha_esp == null || fecha_esp == ''){ return; };*/
...
$('body').delegate('#registro', 'click', function (){
  var route = "../miembros";
  var token = $('#token').val();
  ...
  $.ajax({
    ...
    error: function (error){
      ...
      swal({
        title: 'Error al registrar miembro',
